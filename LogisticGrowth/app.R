    ...
    mainPanel(
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Logistic vs. exponential",
                           p("There are three plots. The first shows the population size through time while the second and third show population growth and per capita growth rates as a function of population size. Be sure to read the axes!"),
                           p("The letters simply correspond to six points over the time period the model is run. They are meant to help you connect values in one graph to those in another."),
